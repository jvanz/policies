...
It runs `updatecli compose apply --file
./updatecli/update-hauler-manifest.yaml`, which pulls in the
...
```console ./hack/generate-hauler-values.sh --owner <you> --repo <your-fork> \
